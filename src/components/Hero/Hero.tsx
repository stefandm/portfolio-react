  ...
  return (
    <section className="flex flex-col min-h-[70vh] xl:h-[90vh] justify-between  overflow-auto mb-[5vh] md:mb-[15vh] " id='hero'>
      ...
      <div className="self-center  md:self-end w-[65vw] md:w-[50vw] mt-8 md:mr-[5vw] mb-[15vh] ">
        ...
        <div className='mt-6'>
        <Link to="contact" smooth={true} duration={1200} offset={-10} className="hover:cursor-pointer h-[5vh] w-[10vw] font-medium border-[1px] border-black hover:bg-blue-900 hover:text-white rounded-md py-3 px-6 text-lg">
        Get in Touch
          </Link>
        </div>
      </div>
