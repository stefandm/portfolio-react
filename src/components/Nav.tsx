    ...
    <header className="flex justify-between items-center p-5 md:p-10  h-[10vh] sticky top-0 z-10 bg-white opacity-95 ">
      ...
      <nav>
        <ul className="flex space-x-3 md:space-x-6 text-sm md:text-base">
          <li>
          <Link to="aboutme" smooth={true} duration={300} offset={-250} className="hover:cursor-pointer">
              About me 
          </Link>
          </li>
          <li>
          <Link to="skills" smooth={true} duration={300} offset={-230} className="hover:cursor-pointer">
              Skills
          </Link>
          </li>
          <li>
